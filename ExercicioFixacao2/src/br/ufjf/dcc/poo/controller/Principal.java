...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//disciplinas.add(new Disciplina("Algoritmos", 60));
		//disciplinas.add(new Disciplina("Estrutura de Dados", 60));
		//disciplinas.add(new Disciplina("Orientacao a Objetos", 60));
		...
		p.setQuantidadeAula(30);
		p.setDisciplina(disciplinasProfessor);
